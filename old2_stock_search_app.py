...
if uploaded_file:
    # Read only the 'Varekategorikode4' column to get the main categories
    main_categories = pd.read_excel(uploaded_file, usecols=["Varekategorikode4"])["Varekategorikode4"].unique().tolist()
    ...
    main_category_data = data[data["Varekategorikode4"] == selected_main_category]
